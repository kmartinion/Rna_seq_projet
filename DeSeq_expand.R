...
counts_data <- read.table("C:/Users/hansd/OneDrive/Bureau/count.txt", header= TRUE, row.names = 1)
col_data <- read.csv("C:/Users/hansd/OneDrive/Bureau/name_data.txt", header = TRUE, row.names = 1)
